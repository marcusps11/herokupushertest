...
$toEmail = 'marcusps1@gmail.com';                  // replace with your email where you would like to send email
...
$from    = 'yo@forestroad.co.uk';                     // replace with email that will look like sender
